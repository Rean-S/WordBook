...
public class ActivitySer extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_alllogin.setOnClickListener(view -> {
            ...
            ArrayAdapter<String> data = new ArrayAdapter<String>(
                    ActivitySer.this, android.R.layout.simple_list_item_1,cstring);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_add) {
            ...
            intent.setClass(ActivitySer.this,ActivityAdd.class);
            startActivity(intent);
            return true;
        }
        if (id == R.id.action_ser) {
            Intent intent = new Intent();
            intent.setClass(ActivitySer.this,ActivitySer.class);
            startActivity(intent);
            return true;
        }
        if (id == R.id.action_del) {
            Intent intent = new Intent();
            intent.setClass(ActivitySer.this,ActivityDel.class);
            startActivity(intent);
            return true;
        }
        if (id == R.id.action_upd) {
            Intent intent = new Intent();
            intent.setClass(ActivitySer.this,ActivityUpd.class);
            startActivity(intent);
            return true;
        }
